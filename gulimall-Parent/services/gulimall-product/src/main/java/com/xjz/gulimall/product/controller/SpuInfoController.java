...
public class SpuInfoController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupon:spuinfo:list")
    ...
    //@RequiresPermissions("coupon:spuinfo:info")
    ...
    //@RequiresPermissions("coupon:spuinfo:update")
    ...
    //@RequiresPermissions("coupon:spuinfo:delete")
