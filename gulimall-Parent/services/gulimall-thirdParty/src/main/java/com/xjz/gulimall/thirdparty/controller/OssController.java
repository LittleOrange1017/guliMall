...
import com.xjz.gulimall.thirdparty.properties.OssProperties;
...
public class OssController {
    ...
    String host="https://gulimall-bylittleorange.oss-cn-beijing.aliyuncs.com";
    Long expire_time = 3600L;
    String bucket = "gulimall-bylittleorange";
    @RequestMapping("/test")
    public R test()
    {
    ...
    public R policy() throws Exception {
        ...
        AssumeRoleResponseBody.AssumeRoleResponseBodyCredentials sts_data = getCredential(ossProperties);
        ...
        return R.ok().put("data", response).put("code",200);
    }
    ...
    //初始化STS Client
    public static Client createStsClient(OssProperties ossProperties) throws Exception {
        // 工程代码泄露可能会导致 AccessKey 泄露，并威胁账号下所有资源的安全性。以下代码示例仅供参考。
        // 建议使用更安全的 STS 方式。
        com.aliyun.teaopenapi.models.Config config = new com.aliyun.teaopenapi.models.Config()
                .setAccessKeyId(ossProperties.getAccessKey())
                .setAccessKeySecret(ossProperties.getSecretKey());
     ...
     */
    public static AssumeRoleResponseBody.AssumeRoleResponseBodyCredentials getCredential(OssProperties oss) throws Exception {
        com.aliyun.sts20150401.Client client = OssController.createStsClient(oss);
        com.aliyun.sts20150401.models.AssumeRoleRequest assumeRoleRequest = new com.aliyun.sts20150401.models.AssumeRoleRequest()
                // 必填，请确保代码运行环境设置了环境变量 OSS_STS_ROLE_ARN
                .setRoleArn(oss.getStsRoleArn())
                .setRoleSessionName("gulimall");// 自定义会话名称
